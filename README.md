...
| Docker | Any recent version | [Download](https://docs.docker.com/desktop/setup/install/mac-install/) — verify with `docker --version`. Optional — only needed for Selenium Grid mode |
